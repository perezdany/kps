            ...
            <form class="form-horizontal" action="add_customer" method="post">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" placeholder="Ex: 0022515478920" required name="tel">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" placeholder="Ex : Cocody Vallon, Yopougon Marco etc..." required name="adresse">
                  </div>
                </div>
