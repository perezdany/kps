        ...
        <div class="container-fluid page-header mb-5 p-0" style="background-image: url(../img/carousel-1.jpg);">
            <div class="container-fluid page-header-inner py-5">
                <div class="container text-center pb-5">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">Mon Espace</h1>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-5"><span class="text-primary text-uppercase">Vos Informations</span></h1>
                </div>
                <div class="row g-4">
                    ...
                    @foreach($get as $user)
                        <div class="col-md-6">
                            <div class="wow fadeInUp" data-wow-delay="0.2s">
                                <form method="post" action="edit_my_customer_account">
                                    @csrf
                                    <input type="text" value="{{$user->id}}" style="display:none;" name="id_customer">
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <input type="text" value="{{$user->nom_prenoms}}" class="form-control" id="name"  name="name" onkeyup="this.value=this.value.toUpperCase()" required>
                                                <label >Nom & Prénom(s)</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <input type="text" value="{{$user->email}}" class="form-control" id="email"  name="email" required onkeyup="this.value=this.value.toLowerCase()">
                                                <label>Email</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <input type="text" value="{{$user->tel}}" class="form-control" id=""  name="tel" required>
                                                <label for="">Téléphone: ex 0102030405</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <input type="text" value="{{$user->adress_geo}}" class="form-control" id="" name="adresse" required>
                                ...
                                <form method="post" action="edit_my_customer_pass">
                                    @csrf
                                    <div class="row g-3">
                                        <!-- MOT DE PASSE-->
